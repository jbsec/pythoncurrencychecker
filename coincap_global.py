...
global_cap = results["data"]["quotes"]["GBP"]["total_market_cap"]
global_volume = results["data"]["quotes"]["GBP"]["total_volume_24h"]
...
print("The global cap of all cryptocurrencies is " + global_cap_string + " and the 24 hour global volume is " + global_volume_string)
print("Bitcoin\'s total percentage of the global cap is " + str(bitcoin_percentage) + ".")
print()
print("This data was last updated on " + str(last_updated_string) + ".")
